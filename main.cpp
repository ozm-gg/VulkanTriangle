...
private:
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.model = glm::rotate(glm::mat4(1.0f), cos(time) * glm::radians(50.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    ...
    void createGraphicsPipeline() {
        ...
        std::cout << "Size of loaded vertex shader code: " << vertShaderCode.size() << std::endl;
        std::cout << "Size of loaded fragment shader code: " << fragShaderCode.size() << std::endl;
